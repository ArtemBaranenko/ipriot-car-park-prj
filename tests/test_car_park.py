...
class TestCarPark(unittest.TestCase):
      ...
      def setUp(self):
         self.log_filename = "new_log.txt"
         self.car_park = CarPark("123 Example Street", 100, log_file = self.log_filename)

      def test_car_park_initialized_with_all_attributes(self):
         self.assertIsInstance(self.car_park, CarPark)
         self.assertEqual(self.car_park.log_file, Path(self.log_filename))
      ...
      def test_car_logged_when_entering(self):
         new_carpark = CarPark("123 Example Street", 100, log_file = self.log_filename) # TODO: change this to use a class attribute or new instance variable
