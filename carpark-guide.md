...
```markdown
![Initial commit](initial_commit.png)
```
...
| ---------- | ---------- | -------------------------------------------------------------------------------- |
| `CarPark`  | `plates`   | `carIn()`, `carOut()`                                                            |
| `Sensor`   |            | `In()`, `Out()`                                                                  |
| `Display`  |            | `showAvailability()`, `showAmbientTemperature()`, `showArbitraryAnnouncements()` |
...
>
> This kind of bidirectional association adds complexity and typically we would handle it by having some "mediating" class. In this project you can \*_choose_ whether to have only one-way associations or bidirectional associations.
>
...
>
>    - _The number of available bays_ > `Answer here...`
>    - _The current temperature_ > `Answer here...`
>    - _The time_ > `Answer here...`
>
> 2. **What is the difference between an attribute and a property?** > `Answer here...`
>
> 3. **Why do you think we used a dictionary to hold the data we passed the display? List at least one advantage and one disadvantage of this approach.** > `Answer here...`
